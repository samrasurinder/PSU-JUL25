...
opatch apply -silent -oh ${GI_HOME} -local ${PATCH_DIR}/${COMBO_PATCH_NUMBER}/${BUGNO}/${DBRU_BUG} >> ${LOGFILE}

export LOGFILE=${PATCH_LOG_DIR}/$(hostname)_$(basename "$0")_${OCW_BUG}_${TIMESTAMP}.log
opatch apply -silent -oh ${GI_HOME} -local ${PATCH_DIR}/${COMBO_PATCH_NUMBER}/${BUGNO}/${OCW_BUG} >> ${LOGFILE}

export LOGFILE=${PATCH_LOG_DIR}/$(hostname)_$(basename "$0")_${ACFS_BUG}_${TIMESTAMP}.log
opatch apply -silent -oh ${GI_HOME} -local ${PATCH_DIR}/${COMBO_PATCH_NUMBER}/${BUGNO}/${ACFS_BUG} >> ${LOGFILE}

export LOGFILE=${PATCH_LOG_DIR}/$(hostname)_$(basename "$0")_${TOMCAT_BUG}_${TIMESTAMP}.log
opatch apply -silent -oh ${GI_HOME} -local ${PATCH_DIR}/${COMBO_PATCH_NUMBER}/${BUGNO}/${TOMCAT_BUG} >> ${LOGFILE}

export LOGFILE=${PATCH_LOG_DIR}/$(hostname)_$(basename "$0")_${DBWLM_BUG}_${TIMESTAMP}.log
opatch apply -silent -oh ${GI_HOME} -local  ${PATCH_DIR}/${COMBO_PATCH_NUMBER}/${BUGNO}/${DBWLM_BUG} >> ${LOGFILE}
